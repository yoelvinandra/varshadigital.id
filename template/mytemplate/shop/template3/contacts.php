...
<head>
    <title>Contact Us &#8211; Juno Toys and Games</title>
    <meta charset="UTF-8" />
                ...
                <div class="top_panel_middle">
                    <div class="columns_wrap content_wrap">
                        <div class="contact_logo column-1_4">
                            <div class="logo">
                                <a href="index.html"><img src="images/logo.png" class="logo_main" alt="" width="121" height="74"><img src="images/logo.png" class="logo_fixed" alt="" width="121" height="74"></a>
                            </div>
                        </div>
                        <div class="menu_main_wrap column-3_4">
                            ...
                            <nav class="menu_main_nav_area menu_hover_fade">
                                <ul id="menu_main" class="menu_main_nav">
                                    ...
                                    <li class="menu-item current-menu-ancestor current-menu-parent menu-item-has-children"><a href="#"><span>Pages</span></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item current-menu-item current_page_item"><a href="contacts.html"><span>Contact Us</span></a></li>
