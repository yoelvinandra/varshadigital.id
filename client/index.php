...
<body>
  ...
  <!-- Preloader -->
    ...
    <div class="container-fluid"  style="padding:90px 0px 0px 0px !important;">
        ...
        <nav>
            <ul class="box-primary-nav">
                ...
                <li><a style="color:#ffbf00; font-size:14pt;">Clients</a></li>
    ...
    <div class="title-total" style="background:url('../img/background-client.webp');background-size:cover; background-position:center;padding:150px 0px 150px 0px; text-align:center; width:100%; "><b id="precious-client"style="color:white; font-size:30pt;text-shadow: 2px 2px 10px #000000;">Precious Clients</b></div>
    <!-- Client -->
    <div class="col-md-12" style="background:white; padding:50px 10px 50px 10px">
          <div id="myclient" class="row" style="margin: 0px 20% 0px 20%">
            </div>
            <br>
            <div class="col-md-5">
            </div> 
  ...
  <script>
   ...
   $.ajax({url: filesDirectory,async:false,cache:false}).then(function(html) {
   			...
   			if(indexLoop > 5)
   			{
   				 ...
   				 if(fileUrl.split("/")[fileUrl.split("/").length-1] == "" && fileName != "Parent Directory")
   				 {
   					...
   					$("#myclient").append(
   					       ...
   					       '<a href="./myclient/'+fileName+'"><span id="gambarForward'+(counter)+'" class="imageMove  col-xs-12 col-sm-2 col-md-3" style="border:0px !important;"><img  src="../client/myclient/'+fileName+'.webp" alt="'+fileName+' bekerja sama dengan varsha digital untuk mengembangkan bisnisnya melalui media sosial" style="width:100%"/>'+
                             '</span></a>'
   					);
    ...
    function changeView() {
        ...
        {
            $("#medsos").hide();
            $("#precious-client").css("font-size","24pt");
        }
